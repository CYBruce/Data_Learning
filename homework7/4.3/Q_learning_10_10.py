...
if __name__ == "__main__":
    ...
    epoch = 0
    actions = [1,1,1,1,1,1,3,3,3,3,1,1,3,3,3,3,3,1]
    while True:
        action = smart_mouse.do(current_state)
        ...
        if done:
            ...
            plt.savefig("10_10_q_table.png")
            print("***" * 10)
            print("total discounted reward=",total_discounted_reward) #total discounted reward= 0.7348413749474103
            print("***" * 10)
            break
